...
export const AuthProvider = ({ children }) => {
  ...
  const login = async(authToken, loginUserNickname, loginUserEmail,loginUserLocation) => {
    ...
    console.log("사용자 정보 확인",loginUserID, loginUserEmail, loginUserNickname, loginUserEmail, authToken, loginUserLocation);
    try {
...
//   const login = async (authToken, loginUserNickname, loginUserID, loginUserEmail, loginUserLocation) => {
//     try {
//       // AsyncStorage에 토큰 및 사용자 정보 저장
//       await AsyncStorage.setItem('token', authToken);
//       await AsyncStorage.setItem('userNickname', loginUserNickname);
...
//   return (
//     // <AuthContext.Provider value={{ token, userid, userNickname, userEmail, userLocation, login, logout }}>

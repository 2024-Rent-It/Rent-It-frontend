...
import { useNavigation, useIsFocused } from '@react-navigation/native'; // useNavigation 추가
import { fetchData } from '../../../screens/userTrans/Networks.js';


export default function MessageRoomScreen() {
    const navigation = useNavigation(); // navigation 변수 추가
                        ...
                        <FlatList
                            ...
                            renderItem={({ item }) => (
                                <TouchableOpacity
                                    ...
                                    onPress={() => {
                                        navigation.navigate('Message', { // Link 대신 navigation.navigate 사용
